...
var animal = "Perro"; //En esta parte estoy demostrando que la variable var permite declarar dos variables con el mismo nombre y no daria error, pero hay que tener cuidado al utilizar esto porque se puede redefinir variables que no deseamos
var animal = "Gato y Raton";
...
let marca = "Ferrari"; // Estas variables nos darian error ya que la variable let no se puede redeclarar como lo hacen las variables var.
let marca = "Porsche";//Pero si definimos una variable let dentro de un bloque y otra global con el mismo nombre , no nos daria error.
